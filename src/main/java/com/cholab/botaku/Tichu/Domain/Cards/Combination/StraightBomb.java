...
public class StraightBomb extends TichuCardCombination {
    public StraightBomb(List<Card> cardList) throws Exception {
        super(cardList);
        verifyInput();
        this.isBomb = true;
    }
    ...
    public TichuCardCombinationType getType() {
        return TichuCardCombinationType.BOMB_STRAIGHT;
    }
}
